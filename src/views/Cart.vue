<template>
    <div class="w-full h-full overflow-y-auto overflow-x-hidden px-2">
        <div class="w-full h-full overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700"
            id="checkout">
            <div class="flex items-end lg:flex-row flex-col justify-start" id="cart">
                <div class="lg:w-[70%] md:w-8/12 w-full lg:px-8 lg:py-2 md:px-6 px-4 md:py-2 py-2 bg-white overflow-y-auto overflow-x-hidden lg:h-screen h-auto"
                    id="scroll">
                ...
                <div class="lg:w-[30%] md:w-8/12 w-full bg-gray-100 h-full">
                    <div
                        ...
                        <div>
                            ...
                            <button onclick="checkoutHandler1(true)"
                                class="text-base leading-none w-full py-5  border-gray-800 border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 text-white"
                                style="background-color: rgb(239, 68, 68);">Checkout</button>
                        </div>
                    </div>
                </div>
            </div>
